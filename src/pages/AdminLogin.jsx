  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-black">
      <div className="bg-white/10 backdrop-blur-lg p-8 rounded-xl w-96">
        ...
        <input type="email" placeholder="Email" className="w-full p-2 mb-2 rounded" value={email} onChange={e=>setEmail(e.target.value)} />
        ...
        <button onClick={handleLogin} className="w-full bg-blue-600 p-2 rounded hover:bg-blue-700">تسجيل الدخول</button>
      </div>
    </div>
  );
}
